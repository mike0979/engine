...
{
public:
	typedef std::function <SnObject*(SystemManager*, uint64_t sn, Targs...)> FactoryFunction;
    ...
    SnObject* Create(SystemManager* pSysMgr, const std::string className, uint64_t sn, Targs... args)
	{
		_lock.lock();
