...
public:
    ...
    template<class T, typename ...TArgs>
    void CreateComponentWithSn(uint64_t sn, TArgs... args);
...
private:
    ...
    template<class T, typename ...TArgs>
    void CreateComponentWithSn(ThreadType iType, uint64_t sn, bool isToAllThead, TArgs... args);
    ...
    template <typename...Args>
    void AnalyseParam(Proto::CreateComponent& proto, uint64_t value, Args...args);
...
template <class T, typename ... TArgs>
void ThreadMgr::CreateComponentWithSn(uint64_t sn, TArgs... args)
{
...
{
    CreateComponentWithSn<T>(iType, static_cast<uint64_t>(0), isToAllThead, std::forward<TArgs>(args)...);
}

template <class T, typename ... TArgs>
void ThreadMgr::CreateComponentWithSn(ThreadType iType, uint64_t sn, bool isToAllThead, TArgs... args)
{
...
template <typename ... Args>
void ThreadMgr::AnalyseParam(Proto::CreateComponent& proto, uint64_t value, Args... args)
{
    auto pProtoParam = proto.mutable_params()->Add();
