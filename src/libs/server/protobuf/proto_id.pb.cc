...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_5fid_2eproto = {
  false, false, descriptor_table_protodef_proto_5fid_2eproto, "proto_id.proto", 1949,
...
static bool dynamic_init_dummy_proto_5fid_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_proto_5fid_2eproto)), true);
namespace Proto {
