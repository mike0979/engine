...
LastWorld::LastWorld(const int worldId, const uint64_t worldSn, const Vector3 pos)
{
...
void PlayerComponentLastMap::EnterWorld(const int worldId, const uint64_t worldSn)
{
	auto pResMgr = ResourceHelp::GetResourceManager();
...
void PlayerComponentLastMap::EnterDungeon(const int worldId, const uint64_t worldSn, const Vector3 position)
{
	if (_pDungeon == nullptr)
	{
